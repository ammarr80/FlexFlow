import { Star,CornerDownLeft,CheckCircle, CheckCheck, CircleCheckBig, createIcons, TrendingUp,Phone, Search, ToolCase, Check, Wrench, UserRound, Droplets, Bath, Flame} from "lucide";

document.addEventListener("DOMContentLoaded", () => {
  createIcons({
    icons: {
      TrendingUp, CheckCheck, CircleCheckBig, CornerDownLeft,Phone, Search, ToolCase, Check, CheckCircle, Wrench, Star, UserRound, Droplets, Bath, Flame
    },
  });
});
